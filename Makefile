#############################################################################
# Makefile for building: amazon
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed May 10 18:40:31 2017
# Project:  amazon.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile amazon.pro
#############################################################################
...
Makefile: amazon.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/amazon1.0.0 || $(MKDIR) .tmp/amazon1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/amazon1.0.0/ && $(COPY_FILE) --parents book.h clothing.h datastore.h db_parser.h heap.h main_window.h movie.h msort.h mydatastore.h product.h product_parser.h review.h user.h util.h .tmp/amazon1.0.0/ && $(COPY_FILE) --parents amazon.cpp book.cpp clothing.cpp db_parser.cpp main_window.cpp movie.cpp mydatastore.cpp product.cpp product_parser.cpp user.cpp util.cpp .tmp/amazon1.0.0/ && (cd `dirname .tmp/amazon1.0.0` && $(TAR) amazon1.0.0.tar amazon1.0.0 && $(COMPRESS) amazon1.0.0.tar) && $(MOVE) `dirname .tmp/amazon1.0.0`/amazon1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/amazon1.0.0
...
mydatastore.o: mydatastore.cpp product.h \
		review.h \
		user.h \
		datastore.h \
		mydatastore.h \
